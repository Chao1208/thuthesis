...
plt.rcParams['axes.titlesize'] = 20  # 增大标题
plt.rcParams['xtick.labelsize'] = 13  # 增大刻度标签
plt.rcParams['ytick.labelsize'] = 13
plt.rcParams['legend.fontsize'] = 14  # 增大图例
...
def create_amo_framework():
    """创建AMO框架图 - 字体更大版本"""
    fig, ax = plt.subplots(figsize=(14, 10))  # 增大画布
    ax.set_xlim(0, 10)
    ax.set_ylim(0, 10)
    ax.axis('off')
    ...
    ax.text(5, 5, '员工\n绩效', 
           ha='center', va='center',
           fontsize=22, fontweight='bold', color='white')  # 增大字体
    ...
    ax.text(2.5, 7.8, '能力', 
           ha='center', va='center',
           fontsize=20, fontweight='bold', color='white')  # 增大字体
    ax.text(2.5, 7.2, 'Ability', 
           ha='center', va='center',
           fontsize=15, color='white', style='italic')  # 增大字体
    ...
    for text in ability_text:
        ax.text(2.5, y_pos, text,
               ha='center', va='center',
               fontsize=12, color=COLORS['secondary'],  # 增大字体
    ...
    print("✓ 已生成图2.1: amo-framework.pdf (字体已增大)")
    plt.close()


def create_imoi_model():
    """创建I-M-O-I团队效能模型图 - 字体更大版本"""
    fig, ax = plt.subplots(figsize=(16, 7))  # 增大画布
    ax.set_xlim(0, 14)
    ax.set_ylim(0, 6)
    ax.axis('off')
    ...
    for stage in stages:
        ...
        ax.text(stage['x'] + stage['w']/2, stage['y'] + stage['h']/2, 
               stage['title'],
               ha='center', va='center',
               fontsize=18, fontweight='bold', color='white')  # 增大字体
    ...
    ax.text(7, 1.2, '反馈循环', 
           ha='center', va='center',
           fontsize=15, color=COLORS['warning'],  # 增大字体
    ...
    plt.savefig('imoi-model.pdf', 
               bbox_inches='tight', dpi=300,
               facecolor='white', edgecolor='none')
    print("✓ 已生成图2.2: imoi-model.pdf (字体已增大)")
    plt.close()


def create_open_innovation_model():
    """创建开放式创新模型图 - 字体更大版本"""
    fig, ax = plt.subplots(figsize=(14, 11))  # 增大画布
    ax.set_xlim(0, 12)
    ax.set_ylim(0, 10)
    ax.axis('off')
    ...
    ax.text(6, 6.5, '企业创新系统', 
           ha='center', va='center',
           fontsize=20, fontweight='bold',  # 增大字体
           color=COLORS['primary'])
    ...
    ax.text(6, 5.2, '内部研发', 
           ha='center', va='center',
           fontsize=17, fontweight='bold', color='white')  # 增大字体
    ax.text(6, 4.6, 'Internal R&D', 
           ha='center', va='center',
           fontsize=13, color='white', style='italic')  # 增大字体
    ...
    for inp in external_inputs:
        ...
        ax.text(1.3, inp['y'], inp['text'],
               ha='center', va='center',
               fontsize=13, fontweight='bold', color='white')  # 增大字体
        
        # 箭头指向企业
        ax.annotate('', xy=(3, inp['y']), xytext=(2.3, inp['y']),
                   arrowprops=dict(arrowstyle='->', lw=2.5,  # 增粗箭头
    ...
    ax.text(1.3, 9.5, '外部知识输入', 
           ha='center', va='center',
           fontsize=16, fontweight='bold',  # 增大字体
           color=COLORS['success'])
    ...
    ax.text(6, 1.5, '↔', 
           ha='center', va='center',
           fontsize=35, color=COLORS['primary'])  # 增大箭头
    ax.text(6, 0.9, '双向流动与协同创新', 
           ha='center', va='center',
           fontsize=15, fontweight='bold',  # 增大字体
           color=COLORS['primary'])
    ...
    plt.savefig('open-innovation-model.pdf', 
               bbox_inches='tight', dpi=300,
               facecolor='white', edgecolor='none')
    print("✓ 已生成图2.3: open-innovation-model.pdf (字体已增大)")
    plt.close()
...
def main():
    ...
    try:
        ...
        print("  • 基础字体从10增大到14")
        print("  • 标题字体从18增大到24")
        print("  • 图表文字从9-11增大到12-15")
        print("  • 箭头线宽从2增大到3-4")
        print("  • 画布尺寸整体增大20-30%")
        print("="*70)
        print("生成的文件：")
        print("  1. amo-framework.pdf - AMO框架图（优化版）")
        print("  2. imoi-model.pdf - IMOI团队效能模型（优化版）")
        print("  3. open-innovation-model.pdf - 开放式创新模型（优化版）")
        print("="*70)
