...
\multicolumn{8}{l}{\small 腾讯、美团数据不含2022年以前，``--''表示本文暂未收录该年度数据；腾讯数据为年报``研究及开发成本''科目，未含IT基础设施投入。}
\end{tabular}
\end{table}
...
\bottomrule
\multicolumn{4}{l}{\small 括号内为2023→2024年增速；各公司数据均采用年报``研发费用/研究及开发成本''科目，口径一致。} \\
